...
angular.module('angular-send-feedback').directive('angularFeedback', [
    '$http',
    function($http) {
      return {
        restrict: 'EA',
            ...
            $.feedback = function(options) {
              ...
              var settings = $.extend({
                ...
                tpl: {
                  ...
                  overview:       '<div id="feedback-overview"><div class="feedback-logo">Feedback</div><div id="feedback-overview-description"><div id="feedback-overview-description-text"><h3>Description</h3><p id="feedback-info">We will also send the following information:</p><ul id="feedback-additional-info"></ul></div></div><div id="feedback-overview-screenshot"><h3>Screenshot</h3></div><div class="feedback-buttons"><button id="feedback-submit" class="feedback-submit-btn feedback-btn-blue">Submit</button><button id="feedback-overview-back" class="feedback-back-btn feedback-btn-gray">Back</button></div><div id="feedback-overview-error">Please enter a description.</div><div class="feedback-wizard-close"></div></div>',
              ...
              var html2canvas = settings.html2canvas;
              ...
              if (supportedBrowser) {
                ...
                $(document).on('click', settings.feedbackButton, function(){
                  ...
                  if (settings.postBrowserInfo) {
                    ...
                    function formatBrowserInfo(b) {
                      return 'User agent: ' + b.userAgent + '\n' +
                        'Platform: ' + b.platform;
                    }
                    ...
                    additionalInfo('Your browser information');
                  }

                  if (settings.postURL) {
                    post.url = document.URL;

                    function formatPageInfo(url) {
                      return 'URL: ' + url;
                    }

                    additionalInfo('The URL you are now at');
                  }

                  if (settings.postHTML) {
                    post.html = $('html').html();

                    additionalInfo('The contents of this page');
                  }
